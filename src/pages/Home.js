    ...
    return (
        <div className="homePageWrapper">
            <div className="formWrapper">
                <img className="homePageLogo" src="/codetogether-logo.png" alt="codetogether-logo" />
            ...
            <footer>
                <p className="p">This is a website where you can learn coding together with your friends or be taught by a guide by creating a new room or joining an existing room.</p>
            </footer>
        </div>
    );
};
